...
export default () => (
  <div class="bg-primary relative z-10 py-[120px] bg-blue-600 min-h-screen flex items-center">
      ...
      <div class="-mx-4">
        <div class="w-full px-4">
          <div class="mx-auto max-w-[400px] text-center">
            ...
            <Link
              to={'/'}
              class="hover:text-primary inline-block rounded-lg border border-white px-8 py-3 text-center text-base font-semibold text-white transition hover:bg-blue"
            >
              Go To Home
            </Link>
          </div>
